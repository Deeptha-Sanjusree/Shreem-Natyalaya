        ...
        <div class="space-y-8">
          @for (level of course.syllabus; track level.level) {
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              ...
              <!-- Level Header -->
              <div 
                [class]="'p-6 md:p-8 text-white ' + 
                (level.color === 'green' ? 'bg-gradient-to-r from-green-600 to-green-700' : 
                 level.color === 'yellow' ? 'bg-gradient-to-r from-yellow-600 to-yellow-700' : 
                 level.color === 'orange' ? 'bg-gradient-to-r from-orange-600 to-orange-700' : 
                 level.color === 'blue' ? 'bg-gradient-to-r from-blue-600 to-blue-700' : 
                 'bg-gradient-to-r from-red-600 to-red-700')"
              >
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    <div class="flex items-center mb-2">
                      <span class="text-sm font-semibold uppercase tracking-wider opacity-90">{{ level.level }}</span>
                    ...
                    <h3 class="text-2xl md:text-3xl font-serif font-bold">{{ level.title }}</h3>
                  </div>
              ...
              <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <!-- Theory -->
                  <div>
                    <h4 class="text-xl font-semibold text-ocean-900 mb-4 flex items-center">
                    ...
                    <ul class="space-y-3">
                      @for (item of level.theory; track item) {
                        <li class="flex items-start">
                          <span class="flex-shrink-0 w-2 h-2 bg-ocean-600 rounded-full mt-2 mr-3"></span>
                  ...
                  <div>
                    ...
                    <ul class="space-y-3">
                      @for (item of level.practical; track item) {
                        <li class="flex items-start">
                          <span class="flex-shrink-0 w-2 h-2 bg-yellow-600 rounded-full mt-2 mr-3"></span>
                          <span class="text-gray-700 leading-relaxed">{{ item }}</span>
                        </li>
                      }
                    </ul>
