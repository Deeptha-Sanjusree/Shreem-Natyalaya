  ...
  <section class="bg-gradient-to-br from-ocean-500 via-cream-200 to-yellow-200 py-16 md:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <h1 class="text-2xl md:text-5xl font-serif font-bold text-ocean-900 mb-4">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-20">
        <div class="text-center mb-12">
          <h2 class="text-xl md:text-4xl font-serif font-bold text-ocean-900 mb-3">
        ...
        <div class="max-w-4xl mx-auto mb-12">
          <div class="bg-ocean-50 rounded-lg p-4 md:p-6 mb-6">
            <h3 class="text-lg md:text-xl font-semibold text-ocean-900 mb-4">{{'home.guruParampara.trainingJourneyTitle' | translate }}</h3>
            <ul class="space-y-3 text-sm md:text-base text-gray-700">
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1">{{'home.guruParampara.trainingJourneyBPoint1' | translate }}<strong>{{'home.guruParampara.trainingJourneyBPoint1Bold1' | translate }}</strong>{{'home.guruParampara.trainingJourneyBPoint1.1' | translate }}</span>
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1">{{'home.guruParampara.traningJourneyBPoint2' | translate }}</span>
              </li>
              <li class="flex items-start">
              <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1">{{'home.guruParampara.traningJourneyBPoint3' | translate }}</span>
              </li>
              <li class="flex items-start">
              <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1">{{'home.guruParampara.traningJourneyBPoint4' | translate }}</span>
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1">{{'home.guruParampara.traningJourneyBPoint5' | translate }}</span>
              </li>
            </ul>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          <!-- My Guru -->
          <div class="bg-gradient-to-br from-ocean-600 to-ocean-700 text-white rounded-xl p-4 md:p-6 border-2 border-ocean-800">
            ...
            <h3 class="text-lg md:text-xl font-serif font-bold mb-2 text-center">
          ...
          <!-- Guru's Guru -->
          <div class="bg-gradient-to-br from-cream-50 to-yellow-50 rounded-xl p-4 md:p-6 border-2 border-yellow-200">
            ...
            <h3 class="text-lg md:text-xl font-serif font-bold text-ocean-900 mb-2 text-center">
       ...
       <div class="bg-yellow-50 rounded-lg p-4 md:p-6">
            <h3 class="text-lg md:text-xl font-semibold text-ocean-900 mb-3">{{'home.guruParampara.guruLineage' | translate }}</h3>
            <p class="text-sm md:text-base text-gray-700">{{'home.guruParampara.guruLineageDesc' | translate }}<strong>{{'home.guruParampara.guruLineageDescBold' | translate }}</strong>{{'home.guruParampara.guruLineageDesc1' | translate }}</p>
          </div>
      ...
      <div class="p-4 md:p-12">
        ...
        <div class="max-w-4xl mx-auto mb-12">
          <div class="bg-ocean-50 rounded-lg p-4 md:p-6">
            <h3 class="text-lg md:text-xl font-semibold text-ocean-900 mb-4">{{'home.guruParampara.trainingJourneyTitle' | translate }}</h3>
            <ul class="space-y-3 text-sm md:text-base text-gray-700">
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1"><strong>{{'home.guruParampara.foundationTraining' | translate }}</strong>{{'home.guruParampara.foundationalTrainingDesc' | translate }}</span>
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1"><strong>{{'home.guruParampara.advancedTraining' | translate }}</strong>{{'home.guruParampara.advancedTrainingDesc' | translate }}</span>
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1"><strong>{{'home.guruParampara.techniquesMastered' | translate }}</strong>{{'home.guruParampara.techniquesMasteredDesc' | translate }}</span>
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1"><strong>{{'home.guruParampara.refinedArtistry' | translate }}</strong>{{'home.guruParampara.refinedArtistryDesc' | translate }}</span>
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2 md:mr-3 mt-1 font-bold flex-shrink-0">→</span>
                <span class="flex-1"><strong>{{'home.guruParampara.additionalLearning' | translate }}</strong>{{'home.guruParampara.additionalLearningDesc' | translate }}</span>
              </li>
            </ul>
          </div>
        </div>
